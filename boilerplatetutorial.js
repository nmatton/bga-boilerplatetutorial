 ...
 * -----
 *
 * boilerplatetutorial.js
 *
 * boilerplatetutorial user interface script
 *
...
define([
  ...
  return declare('bgagame.boilerplatetutorial', [customgame.game, boilerplatetutorial.players], {
    constructor() {
      this._activeStates = [];
      this._notifications = [
    ...
    setupInfoPanel() {
      ...
      this._settingsModal = new customgame.modal('showSettings', {
        ...
        contentsTpl: `<div id='boi-settings'>
             <div id='boi-settings-header'></div>
