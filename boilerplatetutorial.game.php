...
class boilerplatetutorial extends Table
{
    /**
     ...
     * by the action defined into `boilerplatetutorial.action.php`.
     *
     * @throws BgaSystemException
     * @see action_boilerplatetutorial::actMyAction
     */
