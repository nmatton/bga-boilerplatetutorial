define(['dojo', 'dojo/_base/declare'], (dojo, declare) => {
  return declare('boilerplatetutorial.players', null, {
    ...
    tplCard(card) {
      return `
        <div id='card-${card.id}' class='boi-card'>
          <div class='boi-card-fixed-size' data-color='${card.color}' data-value='${card.value}'></div>
        </div>
      `;
    },
  });
